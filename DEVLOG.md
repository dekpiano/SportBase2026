...
- ✅ **เพิ่มระบบแสดงพรีวิวยืนยันรูปภาพก่อนบันทึก (Pre-save Image Previews)**:
  - เพิ่มการสร้าง Blob URL (`URL.createObjectURL`) แสดงรูปภาพขนาดเล็กทันทีที่กดเลือกรูปภาพเพิ่มเติมในช่องอัปโหลด พร้อมป้ายกำกับ 🏷️ **"รอการบันทึก"** ให้ผู้ใช้งานตรวจสอบก่อนกดยืนยันบันทึก
